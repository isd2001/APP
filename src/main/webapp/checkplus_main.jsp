...
<%
    ...
    String url = request.getRequestURL().toString().replace(request.getRequestURI(),"").replace("http:", "https:") + "/app_api";
...
//    System.out.println("url : " + url);
    ...
    String sReturnUrl = url + "/checkplus_success.jsp";      // 성공시 이동될 URL
    String sErrorUrl = url + "/checkplus_fail.jsp";          // 실패시 이동될 URL
