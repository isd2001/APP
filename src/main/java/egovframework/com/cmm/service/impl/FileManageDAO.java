...
public class FileManageDAO extends EgovComAbstractDAO {
	...
	public List<FileVO> selectFileInfs(String fileId) {
		return (List<FileVO>) list("FileManageDAO.selectFileList", fileId);
	}
	...
	public void updateDownloadCount(FileVO fvo) throws Exception {
		update("FileManageDAO.updateDownloadCount", fvo);
	}
}
